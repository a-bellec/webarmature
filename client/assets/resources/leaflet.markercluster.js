...
!(function(t, e) {
  L.MarkerClusterGroup = L.FeatureGroup.extend({options: {maxClusterRadius: 80, iconCreateFunction: null, spiderfyOnMaxZoom: !0, showCoverageOnHover: !0, zoomToBoundsOnClick: !0, singleMarkerMode: !1, disableClusteringAtZoom: null, removeOutsideVisibleBounds: !0, animateAddingMarkers: !1, spiderfyDistanceMultiplier: 1, chunkedLoading: !1, chunkInterval: 200, chunkDelay: 50, chunkProgress: null, polygonOptions: {}}, initialize(t) {
          ...
          d = L.bind(function() {
            for(var e = (new Date()).getTime(); u < t.length; u++) {
              if(a && u % 200 === 0) {
                ...
                if(!this.hasLayer(s) && (this._addLayer(s, this._maxZoom), s.__parent && s.__parent.getChildCount() === 2)) {
    ...
    var i = function() {
      if((t._icon || t.__parent._icon) && !this._inZoomAnimation) {
        if(this._map.off('moveend', i, this), this.off('animationend', i, this), t._icon)e(); else if(t.__parent._icon) {
          var n = function() {
    ...
    var e = this._map; e.getMaxZoom() === e.getZoom() ? this.options.spiderfyOnMaxZoom && t.layer.spiderfy() : this.options.zoomToBoundsOnClick && t.layer.zoomToBounds(), t.originalEvent && t.originalEvent.keyCode === 13 && e._container.focus();
  }, _showCoverage(t) {
    ...
    var t = this._map.getMaxZoom(),
      ...
      i = e; typeof e != 'function' && (i = function() {
        return e;
    ...
    var i, n,
      ...
      r = this._gridUnclustered; for(this.options.singleMarkerMode && (t.options.icon = this.options.iconCreateFunction({getChildCount() {
        return 1;
      }, getAllChildMarkers() {
        return [t];
      }})); e >= 0; e--) {
  ...
  }, _animationAddLayerNonAnimated(t, e) {
    if(e === t) this._featureGroup.addLayer(t); else if(e._childCount === 2) {
      e._addToMap(); var i = e.getAllChildMarkers(); this._featureGroup.removeLayer(i[0]), this._featureGroup.removeLayer(i[1]);
    } else e._updateIcon();
  }}), L.MarkerClusterGroup.include(L.DomUtil.TRANSITION ? {_animationStart() {
  ...
  var i, n,
    ...
    o = this._grid,
    a = o[r] = o[r] || {},
    h = a[s] = a[s] || []; for(delete this._objectPoint[L.Util.stamp(t)], i = 0, n = h.length; n > i; i++) if(h[i] === t) return h.splice(i, 1), n === 1 && delete a[s], !0;
}, eachObject(t, e) {
  var i, n, s, r, o, a, h,
...
}()), L.MarkerCluster.include({getConvexHull() {
  var t, e,
    i = this.getAllChildMarkers(),
    n = []; for(e = i.length - 1; e >= 0; e--)t = i[e].getLatLng(), n.push(t); return L.QuickHull.getConvexHull(n);
}}), L.MarkerCluster.include({_2PI: 2 * Math.PI, _circleFootSeparation: 25, _circleStartAngle: Math.PI / 6, _spiralFootSeparation: 28, _spiralLengthStart: 11, _spiralLengthFactor: 5, _circleSpiralSwitchover: 9, spiderfy() {
...
}}), L.MarkerClusterGroup.include({_spiderfied: null, _spiderfierOnAdd() {
