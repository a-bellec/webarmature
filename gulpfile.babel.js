// Generated on 2017-03-20 using generator-angular-fullstack 4.1.4
'use strict';
...
gulp.task('inject:css', () => gulp.src(paths.client.mainStyle)
        .pipe(plugins.inject(
...
gulp.task('styles', () => gulp.src(paths.client.styles)
        .pipe(styles())
